                    ...
                    <form method="POST" action="{{ route('clubs.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="name" value="{{ old('name') }}" placeholder="club name" autofocus>
                                @error('name')
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="agreement" type="checkbox" class="@error('agreement') is-invalid @enderror" name="agreement" value=1>
                            @error('agreement')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
