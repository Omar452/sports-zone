...
<div class="container col-12 py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit your club') }}</div>
                    ...
                    <form method="POST" action="{{ route('clubs.update', $club) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="name" value="{{ old('name') ? : $club->name }}" placeholder="club name" autofocus>
                                @error('name')
                        ...
                        <div class="form-group row">
                            <label for="sports" class="col-md-4 col-form-label text-md-right">Choose sport(s)</label>
                            ...
                            <div class="{{ $errors->first('sports') }}">
                                <p style="color:#E3342F;">{{ $errors->first('sports') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" placeholder="club description"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                 value="{{ old('email') ? :$club->email }}" placeholder="club email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="text" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" 
                       ...
                       <div class="form-group row">
                        <label for="owner" class="col-md-4 text-md-right">{{ __('I agee terms and conditions and confirm to be the club owner') }}</label>

                        <div class="col-md-6">
                            <input id="agreement" type="checkbox" class="@error('agreement') is-invalid @enderror" name="agreement" value=1 checked>
                            @error('agreement')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
